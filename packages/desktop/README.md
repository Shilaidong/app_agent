...
- 最新版本：`1.1.31`（先行版 preview：嵌套小表行为门 + terminated 流自动重试/续跑 + 对话区防冻结防闪烁；稳定版 `1.1.17` / tag `desktop-v1.1.17-stable`）
...
```bash
git tag -a desktop-v1.1.31-preview -m "Terra-Edu Application Agent 1.1.31 (preview)"
git push origin desktop-v1.1.31-preview
```
