...
assert(source.includes("open -gj \"$APP_PATH\" --args --no-default-browser-check --no-first-run"), "Terra ego-browser wrapper must suppress bundled ego lite's first-run/default-browser promotion")
